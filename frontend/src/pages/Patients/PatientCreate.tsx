...
// DIALYSIS_MODES 列举了不同的透析方式，比如HD（血液透析）、HDF（血液透析滤过）、HP（血浆置换）等。
// 这里类型为 FormValues['dialysis_mode'] 的数组。
const DIALYSIS_MODES: Array<FormValues['dialysis_mode']> = ['HD', 'HD', 'HD', 'HDF', 'HP'];
